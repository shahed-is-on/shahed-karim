 ...
 */
{
    ...
    class HoverImgFx3 {
        ...
        initEvents() {
            this.positionElement = (ev) => {
                ...
                this.DOM.reveal.style.top = `${mousePos.y-130-docScrolls.top}px`;
    ...
    class HoverImgFx25 {
        constructor(el) {
            this.DOM = {el: el};
            this.DOM.reveal = document.createElement('div');
            this.DOM.reveal.className = 'tp-img-reveal-wrapper-sm';
            this.DOM.reveal.style.overflow = 'hidden';
            this.DOM.reveal.innerHTML = `<div class="tp-img-reveal-wrapper__inner">
                <div class="tp-img-reveal-wrapper__img" style="background-image:url(${this.DOM.el.dataset.img ? this.DOM.el.dataset.img: ''})">  
                </div>
    ...
    [...document.querySelectorAll('[data-fx="25"] > .tp-img-reveal-item, .tp-img-reveal-item[data-fx="25"]')].forEach(link => new HoverImgFx25(link));
