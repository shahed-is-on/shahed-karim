...
<div id="smooth-wrapper">
            ...
            <div class="row">
               <div class="blog-list__title-box">
                  <div class="blog-list__text-sm">
                     <span class="category">Blog</span><i class="fa-regular fa-angle-right"></i><span>Complete Guide to User Flow in UX Design</span>
                  </div>
               ...
               <div class="col-xxl-8 col-xl-8 col-lg-8">
                  <div class="postbox-details__wrapper  tp-blog-sidebar-sticky-area tp-blog-social-sticky-area p-relative">
                     ...
                     <div class="postbox-details__text">
                        <p class="tp-dropcap pb-10">Q Proin faucibus nec mauris a sodales, sed elementum mi tincidunt. Sed eget viverra
                           ...
                           <div class="sidebar__post rc__post">
                              <div class="rc__post mb-30 d-flex align-items-center">
                                 <div class="rc__post-thumb mr-20">
                                    <a href="blog-details.html"><img src="assets/img/blog/sidebar-1.jpg" alt=""></a>
                                 </div>
                              ...
                              <div class="rc__post mb-30 d-flex align-items-center">
                                 <div class="rc__post-thumb mr-20">
                                    <a href="blog-details.html"><img src="assets/img/blog/sidebar-2.jpg" alt=""></a>
                                 </div>
                                 <div class="rc__post-content">
                                    <h3 class="rc__post-title">
                           ...
                           <div class="postbox-details___related-content-wrap mb-30">
                              <div class="row align-items-center">
                                 <div class="col-xl-7 col-lg-6">
                                    <h4 class="postbox-details___related-title-sm"><a href="blog-details-2.html">16 witty tips to get six-figure clients on Dribbble</a></h4>
                                 </div>
                           ...
                           <div class="row">
                              <div class="col-xl-12">
                                 <div class="postbox-details___related-thumb mb-80">
                                    <img data-speed="1.1" src="assets/img/blog/related-post.jpg" alt="">
                                 </div>
                              </div>
                           </div>
                           <div class="row">
   ...
   <footer class="cursor-style">
      ...
      <!-- footer area start -->
      <div class="tp-footer-4__main-wrapper black-bg-2 p-relative z-index-1 fix" data-background="assets/img/footer/overly-bg.png">
               ...
               <div class="row align-items-start">
                  ...
                  <div class="col-xl-2 col-lg-2 col-md-4 mb-40">
                     <div class="tp-footer-4__widget footer-col-4-2">
                        ...
                        <ul>
                           <li><a href="#"><i class="fa-regular fa-arrow-right"></i> About</a></li>
                           <li><a href="#"><i class="fa-regular fa-arrow-right"></i> Services</a></li>
                           <li><a href="#"><i class="fa-regular fa-arrow-right"></i> Portfolio</a></li>
                           <li><a href="#"><i class="fa-regular fa-arrow-right"></i> Contact</a></li>
                        </ul>
                     </div>
                  </div>
                     ...
                     <div class="tp-footer-4__widget footer-col-4-3">
                        ...
                        <div class="tp-footer-4__widget-address">
                           <a href="https://www.google.com/maps" target="_blank">
                              California <span></span> <br> 987 Design Blvd, Suite 543, Beverly Hills, CA 902
                           </a>
                        </div>
                     </div>
                  </div>
                  <div class="col-xl-3 col-lg-3 col-md-4 mb-40">
                     <div class="tp-footer-4__widget footer-col-4-4">
                        ...
                        <div class="tp-footer-4__widget-mail">
                           <a href="tel:+1(789)8001234">+1(789) 8001234</a>
                        </div>
                     </div>
                  </div>
               </div>
