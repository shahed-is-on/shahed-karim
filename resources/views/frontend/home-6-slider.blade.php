         ...
         <main>
            ...
            <div id="showcase-slider-main" class="showcase-slider-main">
               ...
               <div class="port-showcase-slider-spaces p-relative">
                  <div class="port-showcase-slider-wrap tp-slider-parallax fix" id="showcase-slider-holder" data-pattern-img="assets/img/webgl/1.jpg">
                                       ...
                                       <div class="port-showcase-slider-item">
                                          <div class="port-showcase-slider-content text-center">
                                             <div class="port-showcase-slider-title">
                                                <div>
                                                   <span><a href="portfolio-details-3.html">Silkvision</a></span>
                                                </div>
                                             </div>
                                    ...
                                    <div class="col-xl-12">
                                       <div class="port-showcase-slider-item">
                                          <div class="port-showcase-slider-content text-center">
                                             <div class="port-showcase-slider-title">
                                                <div>
                                                   <span><a href="portfolio-details-3.html">Top Paddock</a></span>
                                                </div>
                                             </div>
                                             <div class="port-showcase-slider-subtitle">
                                                <div>
                                    ...
                                    <div class="col-xl-12">
                                       <div class="port-showcase-slider-item">
                                          <div class="port-showcase-slider-content text-center">
                                             <div class="port-showcase-slider-title">
                                                <div>
                                                   <span><a href="portfolio-details-3.html">Romain Avalle</a></span>
                                                </div>
                                             </div>
                                             <div class="port-showcase-slider-subtitle">
                                                <div>
                                    ...
                                    <div class="col-xl-12">
                                       <div class="port-showcase-slider-item">
                                          <div class="port-showcase-slider-content text-center">
                                             <div class="port-showcase-slider-title">
                                                <div>
                                                   <span><a href="portfolio-details-3.html">Band Some</a></span>
                                                </div>
                                             </div>
                                             <div class="port-showcase-slider-subtitle">
                                                <div>
               ...
               <div id="canvas-slider" class="canvas-slider">                
                  <div class="slider-img" data-slide="0"><img class="slide-img" src="assets/img/home-60/slider/slider-1.jpg" alt=""></div>
                  <div class="slider-img" data-slide="1"><img class="slide-img" src="assets/img/home-60/slider/slider-2.jpg" alt=""></div>
                  <div class="slider-img" data-slide="2"><img class="slide-img" src="assets/img/home-60/slider/slider-3.jpg" alt=""></div>
                  <div class="slider-img" data-slide="3"><img class="slide-img" src="assets/img/home-60/slider/slider-4.jpg" alt=""></div>
               </div>
               <!--/canvas slider --> 
