      ...
      <div id="smooth-content">
         ...
         <main>
                     ...
                     <div class="col-xl-12">
                        <div class="service-details__tab-wrapper text-center mb-120">
                           <div class="service-details__tab-thumb">
                              <img data-speed="0.4" src="assets/img/services/sv-details.jpg" alt="">
                           </div>
                        </div>
                     </div>
                  </div>
                              ...
                              <div class="row">
                                 <div class="col-xl-6 col-lg-6 col-md-6 mb-20">
                                    <div class="service-details__sm-thumb">
                                       <img src="assets/img/services/sv-details-1.jpg" alt="">
                                    </div>
                                 </div>
                                 <div class="col-xl-6 col-lg-6 col-md-6 mb-20">
                                    <div class="service-details__sm-thumb">
                                       <img src="assets/img/services/sv-details-2.jpg" alt="">
                                    </div>
                                 </div>
                              </div>
                           </div>
                     ...
                     <div class="col-xl-5 col-lg-5">
                        <div class="service-details__right-wrap fix p-relative">
                           ...
                           <div class="service-details__right-text-box">
                              ...
                              <p class="mb-20">Your logo is at the heart of your identity.
            ...
            <div class="ab-brand__area black-bg-3 pb-100 ab-brand__plr">
               <div class="container-fluid">
                  <div class="row gx-20 row-cols-xl-6 row-cols-lg-4 row-cols-md-3">
                     <div class="col-xl mb-20">
                        <div class="ab-brand__item">
                           <a href="#">
                              <span>
         ...
         <footer>
            <div class="tp-footer-bg tp-footer__customize  black-bg-3 p-relative fix z-index-1"
