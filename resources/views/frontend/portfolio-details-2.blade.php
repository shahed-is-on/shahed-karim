...
<body id="body" class="tp-magic-cursor">
         ...
         <div class="tp-offcanvas-left">
            <div class="tp-offcanvas-left-wrap d-flex justify-content-between align-items-center">
               <div class="tpoffcanvas__logo">
                  <img class="logo-white" src="assets/img/logo/logo-red.png" alt="">
   ...
   <div id="smooth-wrapper">
      <div id="smooth-content">
            ...
            <div class="tp-port-2-area tp-port-2-pt coffe-bg">
                  ...
                  <div class="row">
                     <div class="col-xl-12">
                        <div class="tp-port-2-thumb">
                           <img data-speed="0.4" data-lag="0" src="assets/img/portfolio-details-2/port-1.jpg" alt="">
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="container container-1720">
                  <div class="row">
                     <div class="col-xl-12">
                        <div class="tp-port-2-thumb">
                           <img data-speed="0.4" data-lag="0" src="assets/img/portfolio-details-2/port-2.jpg" alt="">
                        </div>
                     </div>
                  </div>
               </div>
                     ...
                     <div class="row">
                        <div class="col-xl-12">
                           <div class="tp-port-2-thumb mb-30">
                              <img data-speed="0.4" data-lag="0" src="assets/img/portfolio-details-2/port-3.jpg" alt="">
                           </div>
                        </div>
                        <div class="col-xl-6 col-lg-6">
                           <div class="tp-port-2-thumb mb-30">
                              <img data-speed="0.4" data-lag="0" src="assets/img/portfolio-details-2/port-4.jpg" alt="">
                           </div>
                        </div>
                        <div class="col-xl-6 col-lg-6">
                           <div class="tp-port-2-thumb mb-30">
                              <img data-speed="0.4" data-lag="0" src="assets/img/portfolio-details-2/port-5.jpg" alt="">
                           </div>
                        </div>
                     </div>
                  </div>
         ...
         <!-- footer area start -->
         <footer>
            <div class="tp-footer-6-area coffe-bg">
               <div class="container container-1720">
                  <div class="tp-footer-6-bdr-tb">
                     <div class="container">
                        <div class="row">
                           <div class="col-xl-12">
                        ...
                        <div class="row justify-content-center">
                           <div class="col-xl-10">
                              <div class="tp-footer-6-social-wrap d-flex align-items-center justify-content-between">
               ...
               <div class="container container-1350">
                  <div class="tp-footer-6-copyright pt-30 pb-30">
                     <div class="row">
