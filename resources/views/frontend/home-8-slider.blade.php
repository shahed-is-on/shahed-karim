                        ...
                        <div class="swiper-wrapper">
                              ...
                              <a class="cursor-hide" href="portfolio-details-2.html">
                                 <div class="portfolio-slider-2-item p-relative not-hide-cursor" data-cursor="View<br>Demo">
                                    <div class="portfolio-slider-2-thumb">
                                       <img src="assets/img/home-07/slider-2-1.jpg" alt="">
                                    </div>
                                    <div class="portfolio-slider-3-content">
                                       <span class="portfolio-slider-3-meta">Modelling - 2012</span>
                                       <h4 class="portfolio-slider-3-title">Siyantika Glory</h4>
                                    </div>
                                 </div>
                              </a>
                           </div>
                           <div class="swiper-slide">
                              <a class="cursor-hide" href="portfolio-details-2.html">
                                 <div class="portfolio-slider-2-item p-relative not-hide-cursor" data-cursor="View<br>Demo">
                                    <div class="portfolio-slider-2-thumb">
                                       <img src="assets/img/home-07/slider-2-2.jpg" alt="">
                                    </div>
                                    <div class="portfolio-slider-3-content">
                                       <span class="portfolio-slider-3-meta">Modelling - 2012</span>
                                       <h4 class="portfolio-slider-3-title">Hannah & John</h4>
                                    </div>
                                 </div>
                              </a>
                           </div>
                           <div class="swiper-slide">
                              <a class="cursor-hide" href="portfolio-details-2.html">
                                 <div class="portfolio-slider-2-item p-relative not-hide-cursor" data-cursor="View<br>Demo">
                                    <div class="portfolio-slider-2-thumb">
                                       <img src="assets/img/home-07/slider-2-5.jpg" alt="">
                                    </div>
                                    <div class="portfolio-slider-3-content">
                                       <span class="portfolio-slider-3-meta">Modelling - 2012</span>
                                       <h4 class="portfolio-slider-3-title">Out of this world</h4>
                                    </div>
                                 </div>
                              </a>
                           </div>
                           <div class="swiper-slide">
                              <a class="cursor-hide" href="portfolio-details-2.html">
                                 <div class="portfolio-slider-2-item p-relative not-hide-cursor" data-cursor="View<br>Demo">
                                    <div class="portfolio-slider-2-thumb">
                                       <img src="assets/img/home-07/slider-2-4.jpg" alt="">
                                    </div>
                                    <div class="portfolio-slider-3-content">
                                       <span class="portfolio-slider-3-meta">Modelling - 2012</span>
                                       <h4 class="portfolio-slider-3-title">The Smiths</h4>
                                    </div>
                                 </div>
                              </a>
                           </div>
                           <div class="swiper-slide">
                              <a class="cursor-hide" href="portfolio-details-2.html">
                                 <div class="portfolio-slider-2-item p-relative not-hide-cursor" data-cursor="View<br>Demo">
                                    <div class="portfolio-slider-2-thumb">
                                       <img src="assets/img/home-07/slider-2-3.jpg" alt="">
                                    </div>
                                    <div class="portfolio-slider-3-content">
                                       <span class="portfolio-slider-3-meta">Modelling - 2012</span>
                                       <h4 class="portfolio-slider-3-title">Digital Paintings</h4>
                                    </div>
                                 </div>
                              </a>
                           </div>
                           <div class="swiper-slide">
                              <a class="cursor-hide" href="portfolio-details-2.html">
                                 <div class="portfolio-slider-2-item p-relative not-hide-cursor" data-cursor="View<br>Demo">
                                    <div class="portfolio-slider-2-thumb">
                                       <img src="assets/img/home-07/slider-2-6.jpg" alt="">
                                    </div>
                                    <div class="portfolio-slider-3-content">
                                       <span class="portfolio-slider-3-meta">Modelling - 2012</span>
                                       <h4 class="portfolio-slider-3-title">Album cover</h4>
                                    </div>
                                 </div>
                              </a>
                           </div>
