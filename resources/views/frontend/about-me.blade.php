...
@section('content')
    <main>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="ab-hero__right-box text-end p-relative mt-25 wow tpfadeLeft" data-wow-duration=".9s"
                            data-wow-delay=".5s">
                            ...
                            <div class="ab-hero__big-img">
                                <img src="assets/img/hero/ab-hero-1.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="ab-info__text">
                            ...
                            <div>
                                I’m Diego <span class="line"></span> a self though & self learned designer
                                ...
                                <a class="tp-hover-reveal-item" href="#">
                                    Product Design
                                    <span></span>
                                    <div class="tp-hover-reveal-bg" data-background="assets/img/about/ab-1.png"></div>
                                </a>,
                                <a class="tp-hover-reveal-item" href="#">
                                    Photography
                                    <span></span>
                                    <div class="tp-hover-reveal-bg" data-background="assets/img/about/ab-2.png"></div>
                                </a> ,
                                <a class="tp-hover-reveal-item" href="#">
                                    Web Design
                                    <span></span>
                                    <div class="tp-hover-reveal-bg" data-background="assets/img/about/ab-3.png"></div>
                                </a> &
                                <a class="tp-hover-reveal-item" href="#">
                                    Graphic Design
                                    <span></span>
                                    <div class="tp-hover-reveal-bg" data-background="assets/img/about/ab-4.png"></div>
                                </a>
                ...
                <div class="row">
                            ...
                            <div class="ab-personal-info__left-box mr-200">
                                <div class="tp-services-wrapper tp-services-capsule-wrapper p-relative"
                                    ...
                                    <div class="ab-personal-info__left-content">
                                        ...
                                        <a href="tel:+4912345678"><span><img src="assets/img/about/whatsap.png"
                                                    alt=""></span> +491 234 5678</a>
                                    </div>
                                    <div class="tp-services-capsule-item-wrapper">
                                        ...
                                        <p data-tp-throwable-el="">
                                            <span class="tp-services-capsule-item"
                                                data-bg-color="#FF759C">Phototyping</span>
                                        </p>
                                        <p data-tp-throwable-el="">
                                        ...
                                        <p data-tp-throwable-el="">
                                            <span class="tp-services-capsule-item" data-bg-color="#00CC97">Brand
                                                strategy</span>
                                        </p>
                                        <p data-tp-throwable-el="">
                                            <span class="tp-services-capsule-item" data-bg-color="#FFDB59"
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="ab-personal-info__right-wrap">
                            ...
                            <div class="ab-personal-info__exprience mb-85 wow tpfadeLeft" data-wow-duration=".9s"
                                data-wow-delay=".5s">
                                <h4 class="ab-personal-info__right-title">
                                    <span>
                                ...
                                <div class="ab-personal-info__exprience-box d-flex align-items-start ">
                                    ...
                                    <div class="ab-personal-info__exprience-content">
                                        <h4 class="ab-personal-info__exprience-title">UI/UX Lead Designer</h4>
                                        <span>Amazon INC</span>
                                    </div>
                                </div>
                                <div class="ab-personal-info__exprience-box d-flex align-items-start ">
                                    <span class="ab-personal-info__exprience-length">2018 - 2022</span>
                                    <div class="ab-personal-info__exprience-content">
                                        <h4 class="ab-personal-info__exprience-title">Product Lead Designer</h4>
                                        <span>Amazon INC</span>
                                    </div>
                                </div>
                                <div class="ab-personal-info__exprience-box d-flex align-items-start ">
                                    <span class="ab-personal-info__exprience-length">2016 - 2018</span>
                                    <div class="ab-personal-info__exprience-content">
                                        <h4 class="ab-personal-info__exprience-title">Graphic Designer</h4>
                                        <span>Amazon INC</span>
                                    </div>
                                </div>
                            </div>
                            <div class="ab-personal-info__exprience mb-85 wow tpfadeRight" data-wow-duration=".9s"
                                data-wow-delay=".7s">
                                <h4 class="ab-personal-info__right-title">
                                    <span>
                                ...
                                <div class="ab-personal-info__exprience-box d-flex align-items-start ">
                                    <span class="ab-personal-info__exprience-length">2014 - 2016</span>
                                    <div class="ab-personal-info__exprience-content">
                                        <h4 class="ab-personal-info__exprience-title">Stanford University</h4>
                                        <span>of California.</span>
                                    </div>
                                </div>
                                <div class="ab-personal-info__exprience-box d-flex align-items-start ">
                                    <span class="ab-personal-info__exprience-length">2012 - 2014</span>
                                    <div class="ab-personal-info__exprience-content">
                                        <h4 class="ab-personal-info__exprience-title">Specialization Course.</h4>
                                        <span>MIT University</span>
                                    </div>
                                </div>
                                <div class="ab-personal-info__exprience-box d-flex align-items-start ">
                                    <span class="ab-personal-info__exprience-length">2009 - 2012</span>
                                    <div class="ab-personal-info__exprience-content">
                                        <h4 class="ab-personal-info__exprience-title">Level High School.</h4>
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 mb-40">
                        <div class="ab-funfact__item space-left-1 wow tpfadeUp" data-wow-duration=".9s"
                            ...
                            <div class="ab-funfact__number">
                                <span data-purecounter-duration="1" data-purecounter-end="56"
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 mb-40">
                        <div class="ab-funfact__item space-left-2 wow tpfadeUp" data-wow-duration=".9s"
                            data-wow-delay=".5s">
                            <div class="ab-funfact__number">
                                <span data-purecounter-duration="1" data-purecounter-end="12"
                                    class="purecounter">0</span>
                            </div>
                            <div class="ab-funfact__content">
        ...
        <!-- award area start -->
        <section class="tp-award-area tp-award-customize black-bg-3 pb-50 pt-120">
            <div class="container">
                <div class="tp-award-inner pb-80">
                    <div class="row">
                        <div class="col-xl-5">
                            <div class="tp-award-wrapper">
                                <div class="tp-section-title-wrapper mb-30">
                                    <div class="tp-section-title-inner p-relative">
                                        <h3 class="tp-section-title tp_title_anim">Awards & recognitions</h3>
                                    </div>
                                </div>
