                        ...
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <p class="text-muted mb-0">Use <code class="fs-14">&lt;i
                                        class="iconoir-cycling"&gt;&lt;/i&gt;</code></p>
                            </div><!--end col-->
                        </div> <!--end row-->
                    </div><!--end card-header-->
                        ...
                        <div class="p-3 border border-primary bg-primary-subtle rounded">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <p class="text-muted mb-0 fs-14">A high-quality selection of free icons. Your new
                                        alternative to Noun Project, Flaticon, and all Figma resources. Available in SVG,
                                        Font, React, React Native, Flutter, Figma and Framer.</p>
                                </div> <!--end col-->
                                <div class="col-auto align-self-center">
                                    <a href="https://iconoir.com/" target="_blank" type="button"
