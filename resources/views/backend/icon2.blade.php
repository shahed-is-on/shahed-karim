        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
                    <h4 class="page-title">Icofont</h4>
                    <div class="">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active">Icofont</li>
                        </ol>
                    </div>
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <p class="text-muted mb-0">Use <code class="fs-14">&lt;i
                                        class="icofont-bathtub"&gt;&lt;/i&gt;</code></p>
                            </div><!--end col-->
                        </div> <!--end row-->
                    </div><!--end card-header-->
                        ...
                        <div class="p-3 border border-primary bg-primary-subtle rounded">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <p class="text-muted mb-0 fs-14">Welcome to IcoFont, your ultimate digital resource for
                                        meticulously crafted icons. IcoFont is a free platform designed to ignite creativity
                                        and breathe life into your digital designs.</p>
                                </div> <!--end col-->
                                <div class="col-auto align-self-center">
                                    <a href="https://icofont.com/" target="_blank" type="button"
                                        class="btn btn-primary">More Icons</a>
                                </div> <!--end col-->
                            </div><!--end row-->
                        </div><!--end div-->
                    </div><!--end card-body-->
