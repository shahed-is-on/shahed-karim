                        ...
                        <div class="p-3 border border-primary bg-primary-subtle rounded">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <p class="text-muted mb-0 fs-14">Swap Font Awesome for modern line icons in one line of
                                        code.</p>
                                    <p class="text-muted mb-0 fs-14">Line Awesome is a free alternative for Font Awesome
                                        5.11.2. It consists of ~1380 flat icons that offer complete coverage of the main
                                        Font Awesome icon set.</p>
                                </div> <!--end col-->
                                <div class="col-auto align-self-center">
                                    <a href="https://icons8.com/line-awesome" target="_blank" type="button"
